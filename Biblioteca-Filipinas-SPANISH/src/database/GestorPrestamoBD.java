...
public class GestorPrestamoBD {
     ...
     */
    public static List<Prestamo> getAllBorrowings() throws SQLException {
        List<Prestamo> borrowings = new ArrayList<>();
        ...
        try (Connection connection = ConexionBD.getDBConnection();
            ...
            while (resultSet.next()) {
                Prestamo borrowing = new Prestamo();
                borrowing.setBorrowingId(resultSet.getInt("borrowing_id"));

                Libro borrowedBook = GestorLibroBD.getBookById(resultSet.getInt("book_id"));
                borrowing.setBook(borrowedBook);
                Lector borrowingReader = GestorLectorBD.getReaderById(resultSet.getInt("reader_id"));
     ...
     * @throws SQLException if there is an error executing the SQL query.
     */
    public static List<Prestamo> getBorrowingsByReaderId(int readerId) {
        List<Prestamo> borrowings = new ArrayList<>();
